...
export default function MaxMusclePage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-[#000000] font-body overflow-x-hidden">
      <style>{`
      ...
      <div aria-hidden="true" className="pointer-events-none">
        <div className="fixed top-16 left-1/2 -translate-x-1/2 w-[140px] h-[140px] sm:w-[300px] sm:h-[300px] bg-red-700/8 rounded-full blur-[60px] sm:blur-[80px]" style={{ animation: 'orb-drift 14s ease-in-out infinite' }} />
        <div className="fixed bottom-0 right-0 w-[120px] h-[120px] sm:w-[260px] sm:h-[260px] bg-red-900/5 rounded-full blur-[50px] sm:blur-[80px]" style={{ animation: 'orb-drift 18s ease-in-out infinite' }} />
      </div>
      ...
      <section className="relative pt-20 pb-0 overflow-hidden">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-8 left-4 w-[140px] h-[140px] sm:w-[300px] sm:h-[300px] rounded-full bg-red-700/10 blur-[60px] sm:blur-[80px]" style={{ animation: 'orb-drift 16s ease-in-out infinite' }} />
          <div className="absolute bottom-8 right-2 w-[140px] h-[140px] sm:w-[300px] sm:h-[300px] rounded-full bg-red-900/6 blur-[60px] sm:blur-[80px]" style={{ animation: 'orb-drift 20s ease-in-out infinite' }} />
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-12 pb-10">
          {/* Label row */}
          <div className="flex items-center gap-3 mb-6 scroll-reveal" style={{ animationDelay: '100ms' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-16 items-end">
            ...
            <div>
              <h1
                ...
                style={{ fontSize: 'clamp(72px, 12vw, 168px)', letterSpacing: '-0.01em', animation: 'fade-up 0.7s cubic-bezier(0.22,1,0.36,1) 0.2s both' }}
              >
            ...
            <div className="lg:max-w-[280px] flex flex-col gap-5 lg:pb-4">
              ...
              {/* Gym photo */}
              <div className="relative w-full overflow-hidden rounded-2xl border border-white/8 shadow-xl shadow-black/60 aspect-[4/3] sm:aspect-square" style={{ animation: 'scale-in 0.65s cubic-bezier(0.22,1,0.36,1) 0.15s both' }}>
                ...
                <div className="sm:hidden absolute inset-x-0 bottom-0 z-10">
                  ...
                  <div className="relative px-4 pb-4 pt-12 flex flex-col gap-2">
                    <Link href="/maxmuscle/signup"
                      className="btn-shine flex items-center justify-between bg-red-600 active:bg-red-700 text-white font-semibold px-5 py-3 rounded-xl text-sm shadow-lg shadow-red-900/50 active:scale-[0.98] transition-all duration-150 min-h-[52px]">
                      <span>Join Now</span>
              ...
              <p className="text-sm text-slate-400 leading-relaxed scroll-reveal" style={{ animationDelay: '350ms' }}>
              ...
              <div className="flex items-center gap-3 flex-wrap scroll-reveal" style={{ animationDelay: '550ms' }}>
              ...
              <div className="hidden sm:flex flex-col gap-2.5">
                <Link href="/maxmuscle/signup"
                  className="btn-shine group relative bg-red-700 hover:bg-red-600 text-white font-semibold px-6 py-3.5 rounded-xl text-sm shadow-xl shadow-red-900/40 flex items-center justify-between overflow-hidden transition-all min-h-[48px]">
                  <span>Join Now</span>
          ...
          {/* Accent rule */}
          <div className="mt-10 flex items-center gap-4 scroll-reveal" style={{ animationDelay: '650ms' }}>
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 py-12 w-full">
        ...
        {/* Mobile carousel */}
        <div className="mb-8 md:hidden scroll-reveal">
          <MobileAboutCarousel />
        </div>
        ...
        <div className="hidden md:grid grid-cols-[1fr_280px] gap-5 mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="group relative scroll-reveal" style={{ animationDelay: '0ms' }}>
              ...
              <div className="relative bg-[#0a0a0a] border border-white/8 rounded-lg overflow-hidden hover:border-red-600/30 transition-all duration-300 sm:hover:-translate-y-1">
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-1 text-[12px] text-slate-300">
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Multiple-time Mr. World Bodybuilding Champion</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>One of India&apos;s most decorated bodybuilders</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Represented India internationally</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Known for discipline & longevity</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Trained & mentored many athletes</span></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative scroll-reveal" style={{ animationDelay: '150ms' }}>
              <div className="absolute -inset-0.5 bg-gradient-to-r from-red-600/0 via-red-600/20 to-red-600/0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur" />
              <div className="relative bg-[#0a0a0a] border border-white/8 rounded-lg overflow-hidden hover:border-red-600/30 transition-all duration-300 sm:hover:-translate-y-1">
                <div className="relative w-full aspect-[1/1.4] overflow-hidden bg-gradient-to-b from-slate-900 to-black">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-1 text-[12px] text-slate-300">
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Elite Indian bodybuilder</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Known as &quot;Indian Hulk&quot;</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>International-level competitor</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Extreme conditioning & stage presence</span></p>
                    <p className="flex items-start gap-2"><span className="text-red-500 mt-0.5 flex-shrink-0">•</span><span>Modern Indian bodybuilding excellence</span></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative group scroll-reveal" style={{ animationDelay: '300ms' }}>
            <div className="absolute -inset-0.5 bg-gradient-to-r from-red-600/0 via-red-600/20 to-red-600/0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur" />
            <div className="relative rounded-lg overflow-hidden border border-red-600/20 hover:border-red-600/40 transition-all duration-300 bg-gradient-to-br from-red-950/20 via-black to-black h-full flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className="text-[13px] text-slate-400 leading-relaxed mb-3 flex-1">
                  Led by world-class champions, our elite team has trained and transformed athletes across national and international stages.
                </p>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 pb-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          <div className="flex flex-col gap-4 h-full scroll-reveal" style={{ animationDelay: '0ms' }}>
          ...
          <div className="flex flex-col gap-4 h-full scroll-reveal" style={{ animationDelay: '150ms' }}>
            <div className="flex-shrink-0">
            ...
            <a
              ...
              className="flex-1 group relative flex flex-col items-center justify-center gap-4 text-center p-8 rounded-2xl border border-white/5 bg-[#0a0a0a] hover:border-pink-500/30 transition-all overflow-hidden sm:hover:-translate-y-1"
            >
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 pb-12 w-full">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4 mb-8 scroll-reveal">
          <div>
            <h2 className="font-display text-3xl sm:text-5xl text-white tracking-wide leading-none">LATEST REELS</h2>
            <p className="text-sm text-slate-500 mt-2">Follow our journey on Instagram</p>
          </div>
          <a href={GYM_INSTAGRAM} target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-sm font-semibold text-pink-400 hover:text-pink-300 transition-colors">
            @maximum_muscle_fitness_studio <ExternalLink className="w-3.5 h-3.5" />
          </a>
        </div>
      ...
      <section id="info-section" className="max-w-6xl mx-auto px-5 sm:px-8 py-12 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden border border-white/5 scroll-reveal">
          <a href={MAPS_OPEN_URL} target="_blank" rel="noopener noreferrer"
            className="group bg-[#0a0a0a] hover:bg-[#0f0f0f] p-6 transition-colors relative overflow-hidden min-h-[90px]">
          ...
          <div className="group bg-[#0a0a0a] p-6 relative overflow-hidden min-h-[90px]">
      ...
      <section id="find-us-section" className="max-w-6xl mx-auto px-5 sm:px-8 pb-16 w-full">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4 scroll-reveal">
          <h2 className="font-display text-3xl sm:text-5xl text-white tracking-wide leading-none">FIND US</h2>
          <div className="flex gap-2">
            <a href={MAPS_OPEN_URL} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-sm px-4 py-2 rounded-lg bg-white/5 border border-white/8 text-slate-300 hover:text-white hover:border-red-600/40 transition-all min-h-[44px]">
              <MapPin className="w-3.5 h-3.5 text-red-400" /> Open in Maps
            </a>
            <a href={MAPS_DIRECTIONS_URL} target="_blank" rel="noopener noreferrer"
              className="btn-shine flex items-center gap-1.5 text-sm px-4 py-2 rounded-lg bg-red-700 hover:bg-red-600 text-white font-semibold transition-all min-h-[44px]">
              <Navigation className="w-3.5 h-3.5" /> Get Directions
            </a>
          </div>
        </div>
        <div className="rounded-2xl overflow-hidden border border-white/5 shadow-2xl shadow-black/60 scroll-reveal" style={{ height: '320px', animationDelay: '200ms' }}>
          <iframe
            src={MAPS_EMBED_URL}
            width="100%"
            height="100%"
      ...
      <footer className="border-t border-white/5 py-6 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-600 scroll-reveal">
